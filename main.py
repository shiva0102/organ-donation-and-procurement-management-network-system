...
def stats():
    ...
    plt.close()  # Close the donor_stat.png figure
    ...
    plt.close()  # Close the Patient_stat.jpeg figure
    ...
    plt.close()  # Close the success.jpeg figure
